...
export default function PlayerView({
  ...
  theme,
  onLoadPlaylist,
  onLoadPlaylistFromTrack, // Receive new prop
  currentPlaylistInfo,
  ...
  }, [currentTrack, theme, API_URL, onColorChange, coverArt]); // Added coverArt to dependencies for consistency
